@extends('components.public.matrix', ['pagina' => 'Trabaja con nosotros'])
                        ...
                        <div id="form1" class=" rounded-2xl flex flex-col gap-4 formulariocontacto font-PlusJakartaSans_Regular">
                            <form class="flex flex-col gap-2 xl:gap-4" id="formContactos">
                              @csrf
                                ...
                                <input type="hidden" name="source" value="trabajaconnosotros">
                                ...
                                <div class="relative">
                                    <input type="text" name="doc_number" id="doc_number" placeholder=" " 
                                        class="peer border-[#262626] focus:border-[#262626] focus:ring-0 font-aceh w-full py-3 px-3 lg:px-4 rounded-lg text-base 2xl:text-xl text-white bg-[#141414]">
                                    <label for="doc_number" class="text-white absolute left-3 top-3 text-sm peer-focus:-top-3 peer-[:not(:placeholder-shown)]:-top-3 transition-all peer-focus:text-sm peer-[:not(:placeholder-shown)]:text-sm peer-focus:bg-[#141414] peer-[:not(:placeholder-shown)]:bg-[#141414] peer-focus:px-1 peer-[:not(:placeholder-shown)]:px-1 2xl:text-lg peer-focus:2xl:text-base peer-[:not(:placeholder-shown)]:2xl:text-base">DNI</label>
                                </div>
                                ...
                                {{-- <div class="flex flex-row">
                                    <select class="js-phone-select-two w-full" name="comunication">
                ...
                <div class="flex flex-row justify-center items-center">
                    {{-- @if ($general[0]->htop && $general[0]->ig_token) --}}
                        <div class="h-[600px] w-full rounded-2xl overflow-hidden" id="map">
                            <img src="{{ asset('images/img/jobabout.png') }}" alt="Imagen de fondo del mapa" class="w-full h-full object-cover">
                        </div>
                    {{-- @endif --}}
                </div>
...
@section('scripts_importados')
    ...
    <script>
        $(document).ready(function() {
            // Inicializar Select2 para el campo de selección de país
            $('.js-phone-select-two').select2({
                width: '100%',
