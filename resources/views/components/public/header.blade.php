    ...
    <div>
        <div class="px-[5%] xl:px-[8%] flex flex-wrap justify-center md:justify-between bg-gradient-to-r from-[#C8A049] via-[#E9D151] via-55% to-[#BE913E] py-3">
            <div class="flex flex-row gap-2 items-center font-PlusJakartaSans_Regular text-sm">
                <a class="relative flex flex-row justify-center items-center gap-2" href="{{route('trabaja')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <mask id="mask0_221_301" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20">
                          <rect width="20" height="20" fill="#D9D9D9"/>
                        </mask>
                        <g mask="url(#mask0_221_301)">
                          <path d="M3.33464 18.3332C2.8763 18.3332 2.48394 18.17 2.15755 17.8436C1.83116 17.5172 1.66797 17.1248 1.66797 16.6665V7.49984C1.66797 7.0415 1.83116 6.64914 2.15755 6.32275C2.48394 5.99636 2.8763 5.83317 3.33464 5.83317H7.5013V3.33317C7.5013 2.87484 7.6645 2.48248 7.99089 2.15609C8.31727 1.8297 8.70964 1.6665 9.16797 1.6665H10.8346C11.293 1.6665 11.6853 1.8297 12.0117 2.15609C12.3381 2.48248 12.5013 2.87484 12.5013 3.33317V5.83317H16.668C17.1263 5.83317 17.5187 5.99636 17.8451 6.32275C18.1714 6.64914 18.3346 7.0415 18.3346 7.49984V16.6665C18.3346 17.1248 18.1714 17.5172 17.8451 17.8436C17.5187 18.17 17.1263 18.3332 16.668 18.3332H3.33464ZM3.33464 16.6665H16.668V7.49984H12.5013C12.5013 7.95817 12.3381 8.35053 12.0117 8.67692C11.6853 9.00331 11.293 9.1665 10.8346 9.1665H9.16797C8.70964 9.1665 8.31727 9.00331 7.99089 8.67692C7.6645 8.35053 7.5013 7.95817 7.5013 7.49984H3.33464V16.6665ZM5.0013 14.9998H10.0013V14.6248C10.0013 14.3887 9.93533 14.17 9.80339 13.9686C9.67144 13.7672 9.48741 13.6109 9.2513 13.4998C8.97352 13.3748 8.69227 13.2811 8.40755 13.2186C8.12283 13.1561 7.82075 13.1248 7.5013 13.1248C7.18186 13.1248 6.87977 13.1561 6.59505 13.2186C6.31033 13.2811 6.02908 13.3748 5.7513 13.4998C5.51519 13.6109 5.33116 13.7672 5.19922 13.9686C5.06727 14.17 5.0013 14.3887 5.0013 14.6248V14.9998ZM11.668 13.7498H15.0013V12.4998H11.668V13.7498ZM7.5013 12.4998C7.84852 12.4998 8.14366 12.3783 8.38672 12.1353C8.62977 11.8922 8.7513 11.5971 8.7513 11.2498C8.7513 10.9026 8.62977 10.6075 8.38672 10.3644C8.14366 10.1214 7.84852 9.99984 7.5013 9.99984C7.15408 9.99984 6.85894 10.1214 6.61589 10.3644C6.37283 10.6075 6.2513 10.9026 6.2513 11.2498C6.2513 11.5971 6.37283 11.8922 6.61589 12.1353C6.85894 12.3783 7.15408 12.4998 7.5013 12.4998ZM11.668 11.2498H15.0013V9.99984H11.668V11.2498ZM9.16797 7.49984H10.8346V3.33317H9.16797V7.49984Z" fill="#141414"/>
                        </g>
                    </svg>
                    <h3>Trabaja con nosotros</h3>
                </a>
                <span class="px-1">|</span> 
                <a class="relative flex flex-row justify-center items-center gap-2" href="{{route('vendeoalquila')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <mask id="mask0_221_307" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20">
                          <rect width="20" height="20" fill="#D9D9D9"/>
                        </mask>
                        <g mask="url(#mask0_221_307)">
                          <path d="M15.832 11.6667V6.25L11.6654 3.33333L7.4987 6.25V7.5H5.83203V5.41667L11.6654 1.25L17.4987 5.41667V11.6667H15.832ZM12.082 6.66667H12.9154V5.83333H12.082V6.66667ZM10.4154 6.66667H11.2487V5.83333H10.4154V6.66667ZM12.082 8.33333H12.9154V7.5H12.082V8.33333ZM10.4154 8.33333H11.2487V7.5H10.4154V8.33333ZM5.83203 15.4167L11.6237 17L16.582 15.4583C16.5126 15.3333 16.4119 15.2257 16.2799 15.1354C16.148 15.0451 15.9987 15 15.832 15H11.6237C11.2487 15 10.9501 14.9861 10.7279 14.9583C10.5056 14.9306 10.2765 14.875 10.0404 14.7917L8.10286 14.1458L8.5612 12.5208L10.2487 13.0833C10.4848 13.1528 10.7626 13.2083 11.082 13.25C11.4015 13.2917 11.8737 13.3194 12.4987 13.3333C12.4987 13.1806 12.4536 13.0347 12.3633 12.8958C12.273 12.7569 12.1654 12.6667 12.0404 12.625L7.16536 10.8333H5.83203V15.4167ZM0.832031 18.3333V9.16667H7.16536C7.26259 9.16667 7.35981 9.17708 7.45703 9.19792C7.55425 9.21875 7.64453 9.24306 7.72786 9.27083L12.6237 11.0833C13.082 11.25 13.4536 11.5417 13.7383 11.9583C14.023 12.375 14.1654 12.8333 14.1654 13.3333H15.832C16.5265 13.3333 17.1168 13.5625 17.6029 14.0208C18.089 14.4792 18.332 15.0833 18.332 15.8333V16.6667L11.6654 18.75L5.83203 17.125V18.3333H0.832031ZM2.4987 16.6667H4.16536V10.8333H2.4987V16.6667Z" fill="#141414"/>
                        </g>
                    </svg>
            ...
            <div class="md:flex flex-wrap gap-6 items-center font-PlusJakartaSans_Regular text-sm hidden">
                <div class="flex flex-row gap-2">
                    ...
                    <h3>(+51) 926 811 809 <span class="px-1">|</span>(+51) 932 073 345</h3>
                </div>
                <div class="flex flex-row gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <h3>informes@mprealstate.com</h3>
                </div>
            </div>
        </div>
